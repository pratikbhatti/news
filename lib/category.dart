...
class _CategoryState extends State<Category> {
  ...
  getNewsByQuery(String query) async {
    ...
    if(query == "Top News" || query == "India"){
      url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=dd139bcde4e045e5b60bea63e5a9e41f";

    }else{
      url ="https://newsapi.org/v2/everything?q=tesla&from=2022-04-30&sortBy=publishedAt&apiKey=dd139bcde4e045e5b60bea63e5a9e41f";
    }
