...
class _HomeState extends State<Home> {
  ...
  getNewsByQuery(String query) async {
    ...
    int i = 0;
    String url =
        "https://newsapi.org/v2/everything?q=tesla&from=2022-04-30&sortBy=publishedAt&apiKey=dd139bcde4e045e5b60bea63e5a9e41f";
  ...
  getNewsofIndia() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=in&apiKey=dd139bcde4e045e5b60bea63e5a9e41f";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
